...
# Read count matrix
count_data <- read.csv("count16hs1.csv", row.names = 1)
...
# Save results
write.csv(as.data.frame(res), "DEG_results_vishwas16h.csv")
...
# Save results as CSV
write.csv(as.data.frame(sig_genes), "Significant_DEGs_vishwas16h.csv")         # All DEGs
write.csv(as.data.frame(upregulated), "Upregulated_Genes_vishwas16h.csv")      # Upregulated
write.csv(as.data.frame(downregulated), "Downregulated_Genes_vishwas16h.csv")  # Downregulated
