...
# Read count matrix
count_data <- read.csv("count16hs2.csv", row.names = 1)

# Read metadata (sample information)
metadata <- read.csv("metadata16hs1.csv", row.names = 1)
...
# Save results
write.csv(as.data.frame(res), "DEG_results_vishwas16hs2.csv")
...
# Save results as CSV
write.csv(as.data.frame(sig_genes), "Significant_DEGs_vishwas16hs2.csv")         # All DEGs
write.csv(as.data.frame(upregulated), "Upregulated_Genes_vishwas16hs2.csv")      # Upregulated
write.csv(as.data.frame(downregulated), "Downregulated_Genes_vishwas16hs2.csv")  # Downregulated
